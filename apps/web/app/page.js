      ...
      <main>
        {isConnected ? (
          <div className="max-w-7xl mx-auto px-6 py-12 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {/* Dashboard Container: Glass Effect léger aussi pour la cohérence */}
...
// --- LANDING PAGE COMPONENT (Style Glassmorphism) ---
function LandingPage() {
  ...
  // --- CLASSES CSS RÉUTILISABLES POUR L'EFFET GLASS ---
  // bg-white/40 : Fond blanc à 40% d'opacité
  // backdrop-blur-xl : Flou d'arrière-plan puissant
  // border-white/50 : Bordure blanche semi-transparente
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        {/* Blobs de couleur vive pour bien voir la transparence */}
        <div 
            className="absolute top-[-10%] left-[20%] w-[700px] h-[700px] bg-purple-600/40 rounded-full blur-[100px] mix-blend-multiply animate-aurora-1 will-change-transform"
            style={{ transform: `translate(${mousePosition.x * -25}px, ${mousePosition.y * -25}px)` }} 
        />
        <div 
            className="absolute bottom-[5%] right-[5%] w-[600px] h-[600px] bg-pink-600/40 rounded-full blur-[90px] mix-blend-multiply animate-aurora-2 will-change-transform"
            style={{ transform: `translate(${mousePosition.x * 35}px, ${mousePosition.y * 35}px)` }} 
        />
        <div 
            className="absolute top-[30%] left-[-15%] w-[800px] h-[800px] bg-violet-600/30 rounded-full blur-[110px] mix-blend-multiply animate-aurora-3 will-change-transform"
      ...
      <div className="relative z-10 flex flex-col gap-32 pb-32">
        ...
        <section className="min-h-[90vh] flex flex-col items-center justify-center text-center px-6 pt-20">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/60 bg-white/30 backdrop-blur-md shadow-sm animate-in fade-in slide-in-from-top-8 duration-1000 mb-8">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-purple-500 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-purple-600"></span>
            </span>
            <span className="text-xs font-bold text-purple-800 tracking-wide uppercase">New Prevention Protocol</span>
          </div>
          ...
          <p className="max-w-2xl mx-auto text-xl text-slate-600 leading-relaxed font-normal mb-12 mix-blend-multiply">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            <button 
              ...
              className="px-8 py-4 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold text-lg hover:shadow-lg hover:shadow-purple-500/30 transition-all active:scale-95 transform"
            >
              Start Now
            </button>
            <button 
              onClick={scrollToFeatures}
              className="px-8 py-4 rounded-full border border-white/50 bg-white/40 backdrop-blur-md text-slate-900 font-medium text-lg hover:bg-white/60 transition-colors flex items-center gap-2 active:scale-95 transform shadow-sm"
            >
              Learn More 
        ...
        {/* FEATURES SECTION (GLASSMORPHISM APPLIQUÉ ICI) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            ...
            <div className={`group relative overflow-hidden flex flex-col justify-center ${glassCardClass}`}>
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600">Transactions settle in 3-5s. No waiting rooms on-chain.</p>
              </div>
            </div>
            ...
            <div className={`group relative overflow-hidden flex flex-col justify-center ${glassCardClass}`}>
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-600">Zero-knowledge principles. Verify status without revealing data.</p>
              </div>
            </div>
        ...
        {/* HOW IT WORKS (Glass effect aussi pour les étapes) */}
      ...
      {/* --- MODALE ONBOARDING (Avec effet Glass) --- */}
      {showOnboarding && (
          ...
          <div className="relative w-full max-w-lg bg-white/90 backdrop-blur-xl border border-white/50 rounded-[2rem] p-8 shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-500 leading-relaxed">Connect your crypto wallet to start.</p>
              </div>

              <div className="flex flex-col gap-3 pt-2">
                <button 
                  onClick={triggerWalletConnection}
                  className="w-full py-3.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold text-lg hover:shadow-lg hover:shadow-purple-500/20 transition-all active:scale-95"
                >
                  Connect Wallet
                </button>
                <button 
